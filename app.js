...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalUnity = setInterval(function(){
            pintarBarra(unity, 15, 3, intervalUnity);
        },100);
        const intervalGodot = setInterval(function(){
            pintarBarra(godot, 16, 4, intervalGodot);
        },100);
        const intervalCanvas = setInterval(function(){
            pintarBarra(canvas, 11, 5, intervalCanvas);
        },100);
    }
}
